...
void CacheInitializer::initialize()
{
    ...
    if(this->_state == CacheInitializer::RequestContacts)
        ...
        this->requestDialogs();
    else if(this->_state == CacheInitializer::RequestStickers)
...
void CacheInitializer::requestStickers()
{
    MTProtoRequest* req = TelegramAPI::messagesGetAllStickers(DC_MainSession, 0);
    connect(req, &MTProtoRequest::replied, this, &CacheInitializer::onRequestStickersReplied);
}
...
void CacheInitializer::onRequestStickersReplied(MTProtoReply *mtreply)
{
    MessagesAllStickers messagesallstickers;
    messagesallstickers.read(mtreply);

    StickerCache_populate(&messagesallstickers);
