...
class PeerNotifySettings: public TelegramObject
{
	Q_OBJECT
	...
	public:
		enum Constructors {
			CtorPeerNotifySettingsEmpty = 0x70a68512,
			CtorPeerNotifySettings = 0x9acda4c0,
		};

	public:
		explicit PeerNotifySettings(QObject* parent = 0);
