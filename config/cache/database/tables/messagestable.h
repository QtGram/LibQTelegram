...
class MessagesTable : public DatabaseTable
{
    ...
    public:
        ...
        Message* previousMessage(Message*message, QHash<MessageId, Message*>& messages, QObject* parent);
        QList<Message*> messagesForDialog(Dialog* dialog, QHash<MessageId, Message *> &messages, int offset, int limit, QObject* parent);
};
