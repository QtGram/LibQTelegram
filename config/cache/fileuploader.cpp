...
FileUploader::FileUploader(MediaType mediatype, const QString &storagepath, QObject *parent) : QObject(parent), _dcsession(NULL), _storagepath(storagepath), _isbigfile(false), _deleteoncompleted(false), _partsize(BlockSize), _partscount(0), _partnum(0)
{
